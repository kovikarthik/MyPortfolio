   ...
   {/* <Footer /> */}
      ...
      <div className="h-screen w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md">
        ...
        <div className="flex header-container">
          ...
          <div className="subtitle-box">
            <p className="text">
              <Typewriter
                options={{
                  strings: ['Karthik Kovi','SaaS Developer'],
                  autoStart: true,
                  loop: true,
                }}
              />
        ...
        <h3 className="md:text-xl text-sm lg:text-xl font-extralight text-center relative z-20 text-gray-400 mt-10 max-w-7xl mb-2 lg:mb-4 pl-4 pr-4">
          I'm a Full Stack Developer passionate about creating innovative software solutions. <br />
          With expertise in both frontend and backend technologies, I enjoy building web and mobile applications from start to finish. <br />
          Particularly interested in SaaS development, I'm always open to collaborating on exciting projects that push the boundaries of technology.
        </h3>
